...
var chbox = document.querySelector('#menu__toggle');
var chlink = document.querySelectorAll('.top-actions__list-link');
...
for (var i = 0; i < chlink.length; i++) {
  chlink[i].addEventListener('click', function () {
    document.body.classList.remove('body--with-menu');
    chbox.checked = false;
    document.querySelector('.menu__logo').src = 'https://raw.githubusercontent.com/vladimir-dublya/layout_creativeBakery/bc8eab8d695a2e911be04083298ba6a73952d543/src/images/menulogo.svg';
  });
